...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[Phones_IteratedDebtorPhonePriorityBunchItemType](@number INT, @DebtorID INT, @Controls VARCHAR(4), @Position INT,
