...
CREATE    VIEW [dbo].[DC_IVRPayInfo]
AS

SELECT dbo.master.number AS ppFileNumber, dbo.master.customer AS ppClientCode, 
	CAST(dbo.master.current0 AS varchar) AS ppamount, 
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[44] 4[16] 2[22] 3) )"
      End
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'DC_IVRPayInfo', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'DC_IVRPayInfo', NULL, NULL
GO
