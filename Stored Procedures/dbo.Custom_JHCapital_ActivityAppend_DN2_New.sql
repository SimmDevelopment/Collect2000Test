...
-- 08/17/2021 BGM Updated to separate new placements from phone stats and also not use notes to gather phone information in order to reduce duplicates.
-- 08/20/2021 BGM Added letter code for options letter OPTDB
-- 09/20/2021 BGM Updated phone call types and letter types to bring them all up to date with new manual.
-- =============================================
CREATE PROCEDURE [dbo].[Custom_JHCapital_ActivityAppend_DN2_New]
...
--exec Custom_JHCapital_ActivityAppend_DN2_New '20210921', '20210921'
