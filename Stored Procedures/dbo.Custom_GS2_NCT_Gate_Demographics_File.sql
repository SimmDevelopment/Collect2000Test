...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_GS2_NCT_Gate_Demographics_File]
...
WHERE dbo.date(ah.DateChanged) BETWEEN dbo.date(@startDate) AND dbo.date(@endDate) AND customer IN ('0001431')
