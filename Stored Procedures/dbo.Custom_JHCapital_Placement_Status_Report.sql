...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_JHCapital_Placement_Status_Report]
...
BEGIN
	...
	--CASE WHEN status IN ('ACT', 'NON') THEN '112010' WHEN status IN ('PPA', 'PDC', 'PCC') THEN '113000' WHEN status = 'MIL' THEN '910208'
	--WHEN status IN ('HOT', 'nsf', 'dcc', 'dbd', 'bkn') THEN '112040' WHEN status LIKE 'VRB' THEN '112030' WHEN status = 'VRD' THEN '191000' WHEN status = 'DSP' THEN '112910'
	--WHEN status = 'B07' THEN '901007' WHEN status = 'B11' THEN '901011' WHEN status = 'B12' THEN '901012' WHEN status = 'B13' THEN '901013'
	--WHEN status = 'BKY' THEN '901007' WHEN status = 'DEC' THEN '902000' WHEN status = 'RSK' THEN '909000' WHEN status IN ('CND', 'CAD') THEN '910120' WHEN status in ('AEX') THEN '910180' 
	--ELSE 
	'112010' AS status_code, dbo.date(GETDATE()) AS status_date
	...
	--'' AS rec_date, CASE WHEN status = 'PDC' THEN (SELECT TOP 1 CONVERT(NVARCHAR(10), deposit, 101) FROM pdc WITH (NOLOCK) WHERE number = m.number AND active = 1 ORDER BY deposit) 
	...
	--CASE WHEN status IN ('hot', 'pdc', 'pcc', 'ppa', 'nsf', 'dcc', 'dbd', 'bkn') THEN 'Y' ELSE '' end AS keeper_flag
	
FROM master m WITH (NOLOCK)
WHERE customer IN (SELECT customerid FROM fact f WITH (NOLOCK) WHERE CustomGroupID in (186,280)) AND returned IS NULL AND CONVERT(VARCHAR(10), m.received, 101) = CONVERT(VARCHAR(10), @received, 101)and id2 not in ('AllGate','ARS-JMET')
--AND (CASE WHEN status IN ('ACT', 'NON') THEN '112010' WHEN status IN ('PPA', 'PDC', 'PCC') THEN '113000' WHEN status = 'MIL' THEN '910208'
--	WHEN status IN ('HOT', 'nsf', 'dcc', 'dbd', 'bkn') THEN '112040' WHEN status LIKE 'VRB' THEN '112030' WHEN status = 'VRD' THEN '191000' WHEN status = 'DSP' THEN '112910'
--	WHEN status = 'B07' THEN '901007' WHEN status = 'B11' THEN '901011' WHEN status = 'B12' THEN '901012' WHEN status = 'B13' THEN '901013'
--	WHEN status = 'BKY' THEN '901007' WHEN status = 'DEC' THEN '902000' WHEN status = 'RSK' THEN '909000' WHEN status IN ('CND', 'CAD') THEN '910120' WHEN status in ('AEX') THEN '910180'
--	ELSE '112010' END <> (SELECT TOP 1 statuscode FROM dbo.Custom_JHCapital_Status_Codes WITH (NOLOCK) WHERE m.id1 = DataID ORDER BY statusdate DESC)
...
--SELECT id1 AS data_id, CASE WHEN status IN ('ACT', 'NON') THEN '112010' WHEN status IN ('PPA', 'PDC', 'PCC') THEN '113000' WHEN status = 'MIL' THEN '910208'
--	WHEN status IN ('HOT', 'nsf', 'dcc', 'dbd', 'bkn') THEN '112040' WHEN status LIKE 'VRB' THEN '112030' WHEN status = 'VRD' THEN '191000' WHEN status = 'DSP' THEN '112910'
--	WHEN status = 'B07' THEN '901007' WHEN status = 'B11' THEN '901011' WHEN status = 'B12' THEN '901012' WHEN status = 'B13' THEN '901013'
--	WHEN status = 'BKY' THEN '901007' WHEN status = 'DEC' THEN '902000' WHEN status = 'RSK' THEN '909000' WHEN status IN ('CND', 'CAD') THEN '910120' WHEN status in ('AEX') THEN '910180'
...
--FROM master m WITH (NOLOCK)
--WHERE customer IN ('0001294', '0001295', '0001296', '0001299', '0001423', '0001424') AND returned IS NULL
--AND (CASE WHEN status IN ('ACT', 'NON') THEN '112010' WHEN status IN ('PPA', 'PDC', 'PCC') THEN '113000' WHEN status = 'MIL' THEN '910208'
--	WHEN status IN ('HOT', 'nsf', 'dcc', 'dbd', 'bkn') THEN '112040' WHEN status LIKE 'VRB' THEN '112030' WHEN status = 'VRD' THEN '191000' WHEN status = 'DSP' THEN '112910'
--	WHEN status = 'B07' THEN '901007' WHEN status = 'B11' THEN '901011' WHEN status = 'B12' THEN '901012' WHEN status = 'B13' THEN '901013'
--	WHEN status = 'BKY' THEN '901007' WHEN status = 'DEC' THEN '902000' WHEN status = 'RSK' THEN '909000' WHEN status IN ('CND', 'CAD') THEN '910120' WHEN status in ('AEX') THEN '910180'
