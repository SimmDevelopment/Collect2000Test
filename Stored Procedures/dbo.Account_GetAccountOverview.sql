...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[Account_GetAccountOverview] @AccountID INTEGER, @LinkID INTEGER = 0
AS
SET NOCOUNT ON;
...
SELECT [AccountID]
FROM [dbo].[fnGetLinkedAccounts](@AccountID, @LinkID);
...
INNER JOIN @Accounts AS [Accounts]
ON [master].[number] = [Accounts].[AccountID]
WHERE [restrictions].[suppressletters] = 1
UNION ALL
SELECT [master].[number],
	[Debtors].[Name],
	'Letters To Attorney'
...
ON [master].[number] = [Accounts].[AccountID]
WHERE [restrictions].[job] = 1
AND [restrictions].[letterstoatty] = 1
UNION ALL
SELECT [master].[number],
	[Debtors].[Name],
	'Disputed'
...
INNER JOIN @Accounts AS [Accounts]
ON [master].[number] = [Accounts].[AccountID]
WHERE [payhistory].[batchtype] LIKE '[PD]%'
...
INNER JOIN @Accounts AS [Accounts]
ON [master].[number] = [Accounts].[AccountID]
WHERE NOT [master].[qlevel] IN ('998', '999')
...
IF EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [type] = 'P' AND [id] = OBJECT_ID('[dbo].[Account_GetAccountOverview_AccountInformation_Custom]')) BEGIN
	EXEC [dbo].[sp_executesql] @stmt = N'EXEC [dbo].[Account_GetAccountOverview_AccountInformation_Custom] @AccountID = @AccountID, @LinkID = @LinkID', @params = N'@AccountID INTEGER, @LinkID INTEGER', @AccountID = @AccountID, @LinkID = @LinkID;
END;
...
INNER JOIN @Accounts AS [Accounts]
ON [master].[number] = [Accounts].[AccountID]
WHERE ([Phones_Master].[PhoneStatusID] IS NULL
...
IF EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [type] = 'P' AND [id] = OBJECT_ID('[dbo].[Account_GetAccountOverview_Demographics_Custom]')) BEGIN
	EXEC [dbo].[sp_executesql] @stmt = N'EXEC [dbo].[Account_GetAccountOverview_Demographics_Custom] @AccountID = @AccountID, @LinkID = @LinkID', @params = N'@AccountID INTEGER, @LinkID INTEGER', @AccountID = @AccountID, @LinkID = @LinkID;
END;
...
IF EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [type] = 'P' AND [id] = OBJECT_ID('[dbo].[Account_GetAccountOverview_Research_Custom]')) BEGIN
	EXEC [dbo].[sp_executesql] @stmt = N'EXEC [dbo].[Account_GetAccountOverview_Research_Custom] @AccountID = @AccountID, @LinkID = @LinkID', @params = N'@AccountID INTEGER, @LinkID INTEGER', @AccountID = @AccountID, @LinkID = @LinkID;
END;
...
IF EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [type] = 'P' AND [id] = OBJECT_ID('[dbo].[Account_GetAccountOverview_WorkEffort_Custom]')) BEGIN
	EXEC [dbo].[sp_executesql] @stmt = N'EXEC [dbo].[Account_GetAccountOverview_WorkEffort_Custom] @AccountID = @AccountID, @LinkID = @LinkID', @params = N'@AccountID INTEGER, @LinkID INTEGER', @AccountID = @AccountID, @LinkID = @LinkID;
END;
...
IF EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [type] = 'P' AND [id] = OBJECT_ID('[dbo].[Account_GetAccountOverview_Legal_Custom]')) BEGIN
	EXEC [dbo].[sp_executesql] @stmt = N'EXEC [dbo].[Account_GetAccountOverview_Legal_Custom] @AccountID = @AccountID, @LinkID = @LinkID', @params = N'@AccountID INTEGER, @LinkID INTEGER', @AccountID = @AccountID, @LinkID = @LinkID;
END;

IF EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [type] = 'P' AND [id] = OBJECT_ID('[dbo].[Account_GetAccountOverview_Custom]')) BEGIN
	EXEC [dbo].[sp_executesql] @stmt = N'EXEC [dbo].[Account_GetAccountOverview_Custom] @AccountID = @AccountID, @LinkID = @LinkID', @params = N'@AccountID INTEGER, @LinkID INTEGER', @AccountID = @AccountID, @LinkID = @LinkID;
END;
