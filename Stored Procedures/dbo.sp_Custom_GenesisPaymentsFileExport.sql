...
EXEC [sp_Custom_GenesisPaymentsFileExport] @invoice
--@customer, @invoiceBegin, @invoiceEnd

*/

CREATE       PROCEDURE [dbo].[sp_Custom_GenesisPaymentsFileExport]
...
BEGIN
	...
	[dbo].[DetermineInvoicedAmount](ph.invoiceflags,ph.paid1,ph.paid2,ph.paid3,ph.paid4,ph.paid5,ph.paid6,ph.paid7,ph.paid8,ph.paid9,ph.paid10) as totalPaid,
	...
	batchtype IN ('PU','PA') and matched = 'N' AND
