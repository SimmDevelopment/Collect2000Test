...
-- Description:	Export via Exchange CreditScore doc for Equabli
-- =============================================
CREATE PROCEDURE [dbo].[Custom_Equabli_Export_CreditScore_V34]
...
--	Exec Custom_Equabli_Export_CreditScore_V34 '20231205', '20231207'

SELECT FORMAT(GETUTCDATE(), 'yyyyMMddHHmmss') AS utcdate

    -- Insert statements for procedure here
	SELECT 'CreditScore' AS recordType
...
, '' AS creditscoreSourceType
, '' AS creditscoreSourceId
, '' AS creditscoreCode
, '' AS dateOfScore
, '' AS creditScore
