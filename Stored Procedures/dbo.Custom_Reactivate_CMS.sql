...
-- Author:		Scott Gorman
-- ALTER  date: 20070516
-- Description:	Reactivate closed accounts for CMS Interface
-- =============================================
CREATE   PROCEDURE [dbo].[Custom_Reactivate_CMS]
	@number as int
AS
BEGIN
	...
	UPDATE MASTER SET
		...
		,ORIGINAL10 = 0
	FROM MASTER M WITH(NOLOCK)
	JOIN Custom_SIMM_CMS_Reactivate CS WITH(NOLOCK) ON CS.SSN = M.ACCOUNT
	WHERE M.NUMBER = @number
