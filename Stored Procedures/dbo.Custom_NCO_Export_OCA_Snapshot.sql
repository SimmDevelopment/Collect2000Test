...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_NCO_Export_OCA_Snapshot] 
...
where m.customer in (select customerid from fact with (Nolock) where customgroupid = 174) and m.closed is null
