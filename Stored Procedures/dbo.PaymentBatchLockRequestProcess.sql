...
-- Description:	Adds a process lock on a batch...
--				Normally called prior to processing a batch.
-- $History: /GSSI/Core/Database/8.1.0/StoredProcedures/dbo.PaymentBatchLockRequestProcess.sql $
--  
--  ****************** Version 2 ****************** 
...
-- =============================================
CREATE PROCEDURE [dbo].[PaymentBatchLockRequestProcess] 
...
BEGIN
	...
	SET @RequestLockType = @ProcessLockType
