...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[Propensio_Profile_AddressAdded]
...
BEGIN
    ...
    BEGIN TRY
        ...
        (@masterNumber, GETDATE(), 'PAYWEB', 'ADDR', 'CHNG',
         'New Address information has been added from PAYWEB - Previous Debtor(1) info was: '
        ...
        VALUES
        ('[Propensio_Profile_AddressAdded]', @AccountId, @UserId, @Username, @IPAddress, @ContactId, @Street1,
