...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_Fortress_AES_Reversal_File]
...
where customer in ('0001034') and invoiced = dbo.date(getdate()) and batchtype = 'pur'
...
where p.customer in ('0001034') and invoiced = dbo.date(getdate()) and batchtype = 'pur'
