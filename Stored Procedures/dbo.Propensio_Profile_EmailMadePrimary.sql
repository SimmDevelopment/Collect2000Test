...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[Propensio_Profile_EmailMadePrimary]
...
BEGIN
    ...
    BEGIN TRY
        ...
        (@masterNumber, @dateupdated, 'PAYWEB', '+++++', '+++++',
         'Primary Email information has been updated from PAYWEB - Email Set to Primary - ' + @EmailAddress, 0);
        ...
        VALUES
        ('[Propensio_Profile_EmailMadePrimary]', @AccountId, @UserId, @Username, @IPAddress, @ContactId, @EmailAddress,
         @statusmessage);
        COMMIT TRANSACTION;
    END TRY
    BEGIN CATCH
