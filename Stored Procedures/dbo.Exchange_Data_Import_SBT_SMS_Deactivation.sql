...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[Exchange_Data_Import_SBT_SMS_Deactivation]
AS
BEGIN
	...
	BEGIN TRY
		...
		declare @ImportName varchar(100) = 'SBT_SMS_Deactivation'
		...
		insert into Custom_SMSDeactivation ( [Group], GroupCode, MobilePhoneNo, FirstName, LastName, Carrier, NewCarrier, Status, DeactivationDate, CreatedOn, UniqueID)
		select data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11 from Exchange_Data_SBT_SMS where import_name = 'SBT_SMS_Deactivation' and Import_Complete = 0
