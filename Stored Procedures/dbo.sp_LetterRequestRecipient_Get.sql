...
SET ANSI_NULLS ON
GO
/*sp_LetterRequestRecipient_Get*/
CREATE Procedure [dbo].[sp_LetterRequestRecipient_Get]
	@KeyID int
AS
-- Name:		sp_LetterRequestRecipient_Get
-- Function:		This procedure will retrieve letter request recipients by LetterRequestID
--			using input parameter @KeyID.
-- Creation:		6/18/2003 
