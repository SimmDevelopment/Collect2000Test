...
SET ANSI_NULLS ON
GO
/*dbo.fusion_Process_ExperianCollectionTriggers*/
CREATE  proc [dbo].[fusion_Process_ExperianCollectionTriggers]
	@number int
AS
BEGIN
-- Name:		fusion_Process_ExperianCollectionTriggers
-- Function:		This procedure will process returned Experian Collection Triggers info
...
ErrHandler:
	RAISERROR('Error encountered in fusion_Process_ExperianCollectionTriggers for account id %d.  fusion_Process_ExperianCollectionTriggers failed.', 11, 1, @number)
	RETURN
END
GO
