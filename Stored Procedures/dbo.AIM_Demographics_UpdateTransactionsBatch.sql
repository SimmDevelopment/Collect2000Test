...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[AIM_Demographics_UpdateTransactionsBatch]
...
ON AR.AccountReferenceID = ATR.AccountReferenceID AND AR.CurrentlyPlacedAgencyID = ATR.AgencyID
AND ATR.TransactionStatusTypeID = 4
AND ATR.TransactionTypeID IN (36,37,38) '
