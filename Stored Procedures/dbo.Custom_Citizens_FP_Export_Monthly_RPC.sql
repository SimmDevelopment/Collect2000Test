...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_Citizens_FP_Export_Monthly_RPC] 
...
AND len(pch.RECORD_KEY) <= 8 AND pch.RECORD_KEY IN (SELECT number FROM master m WITH (NOLOCK) WHERE customer IN ('0002226'))
