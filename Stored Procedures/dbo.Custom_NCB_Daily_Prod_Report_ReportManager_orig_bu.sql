...
-- Changes:	02/14/2024 BGM Row Totals in Query
-- =============================================
CREATE PROCEDURE [dbo].[Custom_NCB_Daily_Prod_Report_ReportManager_orig_bu]
...
-- Exec Custom_NCB_Daily_Prod_Report_ReportManager
