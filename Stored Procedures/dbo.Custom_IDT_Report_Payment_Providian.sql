...
CREATE  PROCEDURE [dbo].[Custom_IDT_Report_Payment_Providian]
@startDate datetime,
@endDate datetime
AS
...
WHERE c.customer = '0000976' AND c.entered BETWEEN @startDate AND @endDate AND c.batchtype = 'PU' AND c.InvoicedPaid > 0
GO
