...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_JHCapital_Account_Update] 
...
WHERE m.customer IN ('0001294', '0001295', '0001296', '0001299', '0001423', '0001424','0001695','0001696','0001697','0001698','0001699','0001700','0001704','0001706') AND dbo.date(ah.DateChanged) BETWEEN dbo.date(@startDate) AND dbo.date(@endDate)and id2 not in ('AllGate','ARS-JMET')
...
WHERE m.customer IN ('0001294', '0001295', '0001296', '0001299', '0001423', '0001424','0001695','0001696','0001697','0001698','0001699','0001700','0001704','0001706') AND dbo.date(ph.DateChanged) BETWEEN dbo.date(@startDate) AND dbo.date(@endDate)and id2 not in ('AllGate','ARS-JMET')
...
WHERE m.customer IN ('0001294', '0001295', '0001296', '0001299', '0001423', '0001424','0001695','0001696','0001697','0001698','0001699','0001700','0001704','0001706') AND dbo.date(b.TransmittedDate) BETWEEN dbo.date(@startDate) AND dbo.date(@endDate)and id2 not in ('AllGate','ARS-JMET')
