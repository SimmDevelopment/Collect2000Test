...
-- Description:	Create Recall file after importing the main maintenance file
...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_USBank_CACS_Export_Recall_File_Old]
...
SET @CustGroupID = 113 --Test	
	...
	--Get Recalls
SELECT  cutr.AgencyID , cutr.LocationCode , cutr.AccountNumber , cutr.TransCode ,cutr.TransDate ,cutr.RecallReason ,cutr.AccountingSysID 
