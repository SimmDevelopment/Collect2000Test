...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_FMC_Export_OCA_Snapshot_BKY] 
...
where m.customer in (select customerid from fact with (Nolock) where customgroupid = 134) and m.closed between @startDate and @endDate and m.status in ('bky', 'b07', 'b11', 'b13', 'dec')
