...
-- Description:	Export via Exchange SMS Preferences doc for Equabli
-- =============================================
CREATE PROCEDURE [dbo].[Custom_Equabli_Export_SMSPreferences_V34]
...
--	Exec Custom_Equabli_Export_SMSPreferences_V34 '20231205', '20231207'

SELECT FORMAT(GETUTCDATE(), 'yyyyMMddHHmmss') AS utcdate

    -- Insert statements for procedure here
	SELECT 'smspreference' AS recordType
