...
/*dbo.fusion_Create_LexisNexisBankruptcy*/
CREATE  PROCEDURE [dbo].[fusion_Create_LexisNexisBankruptcy]
AS
-- Name:		fusion_Create_LexisNexisBankruptcy
-- Function:		This procedure will create required database objects to implement LexisNexis Bankruptcy
-- Creation:		05/11/2006 jc
-- Modified:		10/11/2006 Jeff Mixon
-- 
...
IF NOT EXISTS( SELECT * FROM Services WHERE ManifestId='366A78FA-62A6-410D-ABEE-A3E71E165073')
	INSERT INTO [Services]
	([Description],[Enabled],[UpdateAccounts],[ManifestID],[MinBalance],[TransformationSchema])
	 VALUES
	 ('LexisNexis Bankruptcy',1,0,'366A78FA-62A6-410D-ABEE-A3E71E165073',0,
	'<?xml version="1.0"?>
	<html xsl:version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/TR/xhtml1/strict">
		<head>
			<title>LexisNexis Bankruptcy Data</title>
		</head>
		<body>
