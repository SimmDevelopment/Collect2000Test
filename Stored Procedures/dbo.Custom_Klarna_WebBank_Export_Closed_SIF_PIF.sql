...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_Klarna_WebBank_Export_Closed_SIF_PIF]
...
s.Description AS [Closure_Reason], CONVERT(VARCHAR(10),m.Closed,101) AS [Closed]
