...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_JHCapital_StatusUpdate_DN2_ARS]
...
WHERE customer IN (SELECT customerid FROM fact f WITH (NOLOCK) WHERE CustomGroupID = 186) AND returned IS NULL and id2 in('ARS-JMET')
