...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_GS2_NCT_Gate_AES_Payment_File]
...
where customer in ('0001431') and invoiced = dbo.date(getdate()) and batchtype = 'pu'
...
where p.customer in ('0001431') and invoiced = dbo.date(getdate()) and batchtype = 'pu'
