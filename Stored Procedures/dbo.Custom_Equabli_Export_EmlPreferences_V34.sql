...
-- Description:	Export via Exchange Email Preferences doc for Equabli
-- =============================================
CREATE PROCEDURE [dbo].[Custom_Equabli_Export_EmlPreferences_V34]
...
--	Exec Custom_Equabli_Export_EmlPreferences_V34 '20231205', '20231207'

SELECT FORMAT(GETUTCDATE(), 'yyyyMMddHHmmss') AS utcdate

    -- Insert statements for procedure here
	SELECT 'emlpreference' AS recordType
