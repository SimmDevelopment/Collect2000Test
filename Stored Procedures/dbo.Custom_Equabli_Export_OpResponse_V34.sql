...
-- Description:	Export via Exchange OpResponse doc for Equabli
-- =============================================
CREATE PROCEDURE [dbo].[Custom_Equabli_Export_OpResponse_V34]
...
--	Exec Custom_Equabli_Export_OpResponse_V34 '20231205', '20231207'

SELECT FORMAT(GETUTCDATE(), 'yyyyMMddHHmmss') AS utcdate

    -- Insert statements for procedure here
	SELECT 'opresponse' AS recordType
