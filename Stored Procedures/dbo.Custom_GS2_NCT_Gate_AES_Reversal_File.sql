...
-- =============================================
CREATE PROCEDURE [dbo].[Custom_GS2_NCT_Gate_AES_Reversal_File]
...
where customer in ('0001431') and invoiced = dbo.date(getdate()) and batchtype = 'pur'
...
where p.customer in ('0001431') and invoiced = dbo.date(getdate()) and batchtype = 'pur'
