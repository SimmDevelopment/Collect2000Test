...
--				11/29/2023 BGM Convert to Version 3.4
-- =============================================
CREATE PROCEDURE [dbo].[Custom_Equabli_Export_Placement_File_Maint_Records_V34]
...
WHERE ceci.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE ceei.isPrimary = 'N' AND ceei.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE ceepi.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE cedpi.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE cesi.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE ceshi.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE cersi.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE ceasci.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE ceaaci.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE ceai.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE ceui.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE cecsi.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
...
WHERE cecli.equabliAccountNumber NOT IN (SELECT equabliAccountNumber FROM Custom_Equabli_Account_Info)
END
GO
