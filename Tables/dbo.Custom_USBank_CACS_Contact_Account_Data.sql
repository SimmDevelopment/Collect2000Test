CREATE TABLE [dbo].[Custom_USBank_CACS_Contact_Account_Data]
(
...
GO
ALTER TABLE [dbo].[Custom_USBank_CACS_Contact_Account_Data] ADD CONSTRAINT [PK_Custom_USBank_CACS_Contact_Account_Data] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
