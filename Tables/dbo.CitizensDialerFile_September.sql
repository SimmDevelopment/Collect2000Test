CREATE TABLE [dbo].[CitizensDialerFile_September]
(
...
GO
ALTER TABLE [dbo].[CitizensDialerFile_September] ADD CONSTRAINT [PK_CitizensDialerFile_October] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
