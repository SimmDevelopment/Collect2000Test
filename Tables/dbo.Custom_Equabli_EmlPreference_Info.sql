CREATE TABLE [dbo].[Custom_Equabli_EmlPreference_Info]
(
...
GO
ALTER TABLE [dbo].[Custom_Equabli_EmlPreference_Info] ADD CONSTRAINT [PK_Custom_Equabli_EmlPreference_Info] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
