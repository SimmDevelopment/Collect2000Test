CREATE TABLE [dbo].[Custom_LibreMax_Address]
(
...
GO
ALTER TABLE [dbo].[Custom_LibreMax_Address] ADD CONSTRAINT [PK_Custom_LibreMax_Address] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
