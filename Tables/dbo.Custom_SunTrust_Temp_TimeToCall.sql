CREATE TABLE [dbo].[Custom_SunTrust_Temp_TimeToCall]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_Temp_TimeToCall] ADD CONSTRAINT [PK_SunTrust_Temp_TimeToCall] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
