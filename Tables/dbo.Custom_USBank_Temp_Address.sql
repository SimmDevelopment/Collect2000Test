CREATE TABLE [dbo].[Custom_USBank_Temp_Address]
(
...
GO
ALTER TABLE [dbo].[Custom_USBank_Temp_Address] ADD CONSTRAINT [PK_Custom_USBank_Temp_Address] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
