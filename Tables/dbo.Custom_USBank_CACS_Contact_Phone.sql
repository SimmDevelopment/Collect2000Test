CREATE TABLE [dbo].[Custom_USBank_CACS_Contact_Phone]
(
...
GO
ALTER TABLE [dbo].[Custom_USBank_CACS_Contact_Phone] ADD CONSTRAINT [PK_Custom_USBank_CACS_Contact_Phone] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
