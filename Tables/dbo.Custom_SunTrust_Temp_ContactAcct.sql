CREATE TABLE [dbo].[Custom_SunTrust_Temp_ContactAcct]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_Temp_ContactAcct] ADD CONSTRAINT [PK_Custom_SunTrust_Temp_ContactAcct] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
