CREATE TABLE [dbo].[Custom_Equabli_SMSPreference_Info]
(
...
GO
ALTER TABLE [dbo].[Custom_Equabli_SMSPreference_Info] ADD CONSTRAINT [PK_Custom_Equabli_SMSPreference_Info] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
