CREATE TABLE [dbo].[Custom_USBank_CACS_PrimaryContact_Import]
(
...
GO
ALTER TABLE [dbo].[Custom_USBank_CACS_PrimaryContact_Import] ADD CONSTRAINT [PK_Custom_USBank_CACS_PrimaryContact_Import] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
