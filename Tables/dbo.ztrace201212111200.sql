CREATE TABLE [dbo].[ztrace201212111200]
(
...
GO
ALTER TABLE [dbo].[ztrace201212111200] ADD CONSTRAINT [PK__ztrace2012121112__20E8376D] PRIMARY KEY CLUSTERED ([RowNumber]) ON [PRIMARY]
GO
