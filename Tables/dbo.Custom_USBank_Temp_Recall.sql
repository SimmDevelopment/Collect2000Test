CREATE TABLE [dbo].[Custom_USBank_Temp_Recall]
(
...
GO
ALTER TABLE [dbo].[Custom_USBank_Temp_Recall] ADD CONSTRAINT [PK_Custom_USBank_Temp_Recall] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
