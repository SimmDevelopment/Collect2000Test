CREATE TABLE [dbo].[Custom_MT_CACS_Contact_Address]
(
...
GO
ALTER TABLE [dbo].[Custom_MT_CACS_Contact_Address] ADD CONSTRAINT [PK_Custom_MT_CACS_Contact_Address] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
