CREATE TABLE [dbo].[Custom_USBank_CACS_Contact_Email_Maintenance]
(
...
GO
ALTER TABLE [dbo].[Custom_USBank_CACS_Contact_Email_Maintenance] ADD CONSTRAINT [PK_Custom_USBank_CACS_Contact_Email_Maintenance] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
