CREATE TABLE [dbo].[Custom_MT_Temp_ContactAcct]
(
...
GO
ALTER TABLE [dbo].[Custom_MT_Temp_ContactAcct] ADD CONSTRAINT [PK_Custom_M&T_Temp_ContactAcct] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
