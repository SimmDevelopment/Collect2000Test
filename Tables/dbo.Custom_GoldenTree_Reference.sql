CREATE TABLE [dbo].[Custom_GoldenTree_Reference]
(
...
GO
ALTER TABLE [dbo].[Custom_GoldenTree_Reference] ADD CONSTRAINT [PK_Custom_GoldenTree_Reference] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
