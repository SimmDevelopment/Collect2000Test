CREATE TABLE [dbo].[Custom_Equabli_SMSPreference_History]
(
...
GO
ALTER TABLE [dbo].[Custom_Equabli_SMSPreference_History] ADD CONSTRAINT [PK_Custom_Equabli_SMSPreference_History] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
