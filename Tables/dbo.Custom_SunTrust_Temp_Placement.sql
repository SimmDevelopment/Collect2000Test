CREATE TABLE [dbo].[Custom_SunTrust_Temp_Placement]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_Temp_Placement] ADD CONSTRAINT [PK_Custom_SunTrust_Temp_Placement] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
