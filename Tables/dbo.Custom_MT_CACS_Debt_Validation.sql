CREATE TABLE [dbo].[Custom_MT_CACS_Debt_Validation]
(
...
GO
ALTER TABLE [dbo].[Custom_MT_CACS_Debt_Validation] ADD CONSTRAINT [PK_Custom_MT_CACS_Debt_Validation] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
