CREATE TABLE [dbo].[Custom_SunTrust_C360_RMS_Temp_Placement]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_C360_RMS_Temp_Placement] ADD CONSTRAINT [PK_Custom_SunTrust_C360_RMS_Temp_Placement] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
