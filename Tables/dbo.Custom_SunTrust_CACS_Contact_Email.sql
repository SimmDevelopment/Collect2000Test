CREATE TABLE [dbo].[Custom_SunTrust_CACS_Contact_Email]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_CACS_Contact_Email] ADD CONSTRAINT [PK_Custom_SunTrust_CACS_Contact_Email] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
