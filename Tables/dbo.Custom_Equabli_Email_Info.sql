CREATE TABLE [dbo].[Custom_Equabli_Email_Info]
(
...
GO
ALTER TABLE [dbo].[Custom_Equabli_Email_Info] ADD CONSTRAINT [PK_Custom_Equabli_Email_Info] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
