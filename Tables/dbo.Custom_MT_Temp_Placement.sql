CREATE TABLE [dbo].[Custom_MT_Temp_Placement]
(
...
GO
ALTER TABLE [dbo].[Custom_MT_Temp_Placement] ADD CONSTRAINT [PK_Custom_M&T_Temp_Placement] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
