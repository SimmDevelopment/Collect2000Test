CREATE TABLE [dbo].[Custom_SunTrust_Temp_Phones]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_Temp_Phones] ADD CONSTRAINT [PK_Custom_SunTrust_Temp_Phones] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
