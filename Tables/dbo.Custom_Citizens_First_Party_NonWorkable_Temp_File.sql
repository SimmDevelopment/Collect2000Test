CREATE TABLE [dbo].[Custom_Citizens_First_Party_NonWorkable_Temp_File]
(
...
GO
ALTER TABLE [dbo].[Custom_Citizens_First_Party_NonWorkable_Temp_File] ADD CONSTRAINT [PK_Custom_Citizens_First_Party_NonWorkable_Temp_File] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
