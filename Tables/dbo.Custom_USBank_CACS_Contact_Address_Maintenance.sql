CREATE TABLE [dbo].[Custom_USBank_CACS_Contact_Address_Maintenance]
(
...
GO
ALTER TABLE [dbo].[Custom_USBank_CACS_Contact_Address_Maintenance] ADD CONSTRAINT [PK_Custom_USBank_CACS_Contact_Address_Maintenance] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
