CREATE TABLE [dbo].[Custom_Equabli_DialPreference_History]
(
...
GO
ALTER TABLE [dbo].[Custom_Equabli_DialPreference_History] ADD CONSTRAINT [PK_Custom_Equabli_DialPreference_History] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
