CREATE TABLE [dbo].[Custom_MT_CACS_Contact_Account_Data_Maintenance]
(
...
GO
ALTER TABLE [dbo].[Custom_MT_CACS_Contact_Account_Data_Maintenance] ADD CONSTRAINT [PK_Custom_MT_CACS_Contact_Account_Data_Maintenance] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
