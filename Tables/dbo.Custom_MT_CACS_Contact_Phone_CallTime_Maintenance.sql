CREATE TABLE [dbo].[Custom_MT_CACS_Contact_Phone_CallTime_Maintenance]
(
...
GO
ALTER TABLE [dbo].[Custom_MT_CACS_Contact_Phone_CallTime_Maintenance] ADD CONSTRAINT [PK_Custom_MT_CACS_Contact_Phone_CallTime_Maintenance] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
