CREATE TABLE [dbo].[Custom_SunTrust_CACS_Contact_Email_History]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_CACS_Contact_Email_History] ADD CONSTRAINT [PK_Custom_SunTrust_CACS_Contact_Email_History] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
