...
[SpouseName] [varchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[TypeCode] [varchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Services_LexisNexis_SkipTrace_Return] ADD CONSTRAINT [PK_Services_LexisNexis_SkipTrace_Return] PRIMARY KEY CLUSTERED ([ID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
