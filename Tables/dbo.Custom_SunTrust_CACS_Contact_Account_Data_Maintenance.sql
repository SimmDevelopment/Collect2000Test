CREATE TABLE [dbo].[Custom_SunTrust_CACS_Contact_Account_Data_Maintenance]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_CACS_Contact_Account_Data_Maintenance] ADD CONSTRAINT [PK_Custom_USBank_SunTrust_Contact_Account_Data_Maintenance] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
