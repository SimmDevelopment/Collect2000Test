CREATE TABLE [dbo].[Custom_SunTrust_CACS_Account_Maintenance]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_CACS_Account_Maintenance] ADD CONSTRAINT [PK_Custom_SunTrust_CACS_Account_Maintenance] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
