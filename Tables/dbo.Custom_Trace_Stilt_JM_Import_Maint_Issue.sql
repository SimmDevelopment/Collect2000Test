CREATE TABLE [dbo].[Custom_Trace_Stilt_JM_Import_Maint_Issue]
(
...
GO
ALTER TABLE [dbo].[Custom_Trace_Stilt_JM_Import_Maint_Issue] ADD CONSTRAINT [PK__Custom_T__AAAC09D8B3C6435B] PRIMARY KEY CLUSTERED ([RowNumber]) ON [PRIMARY]
GO
