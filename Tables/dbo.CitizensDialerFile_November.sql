CREATE TABLE [dbo].[CitizensDialerFile_November]
(
...
GO
ALTER TABLE [dbo].[CitizensDialerFile_November] ADD CONSTRAINT [PK_CitizensDialerFile_November] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
