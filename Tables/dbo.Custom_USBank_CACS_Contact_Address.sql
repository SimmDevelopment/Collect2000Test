CREATE TABLE [dbo].[Custom_USBank_CACS_Contact_Address]
(
...
GO
ALTER TABLE [dbo].[Custom_USBank_CACS_Contact_Address] ADD CONSTRAINT [PK_Custom_USBank_CACS_Contact_Address] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
