CREATE TABLE [dbo].[Custom_MT_CACS_PrimaryContact_Import]
(
...
GO
ALTER TABLE [dbo].[Custom_MT_CACS_PrimaryContact_Import] ADD CONSTRAINT [PK_Custom_MT_CACS_PrimaryContact_Import] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
