CREATE TABLE [dbo].[Custom_SunTrust_Temp_BaseContact]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_Temp_BaseContact] ADD CONSTRAINT [PK_Custom_SunTrust_Temp_BaseContact] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
