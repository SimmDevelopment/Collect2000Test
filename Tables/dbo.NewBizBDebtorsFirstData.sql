CREATE TABLE [dbo].[NewBizBDebtorsFirstData]
(
[Number] [int] NULL,
[Seq] [int] NULL,
...
[DateCreated] [datetime] NOT NULL CONSTRAINT [DF__NewBizBDe__DateC__659C8916] DEFAULT (getdate()),
[DateUpdated] [datetime] NOT NULL CONSTRAINT [DF__NewBizBDe__DateU__6690AD4F] DEFAULT (getdate()),
[Country] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[lastName] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[firstName] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[middleName] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[suffix] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[isBusiness] [bit] NOT NULL CONSTRAINT [DF__NewBizBDe__isBus__6784D188] DEFAULT ((0)),
[isParsed] [bit] NOT NULL CONSTRAINT [DF__NewBizBDe__isPar__6878F5C1] DEFAULT ((0)),
[cbrException] [smallint] NOT NULL CONSTRAINT [DF__NewBizBDe__cbrEx__696D19FA] DEFAULT ((0)),
[cbrExclude] [bit] NOT NULL CONSTRAINT [DF__NewBizBDe__cbrEx__6A613E33] DEFAULT ((0)),
[Responsible] [bit] NOT NULL CONSTRAINT [DF__NewBizBDe__Respo__6B55626C] DEFAULT ((1)),
...
[gender] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__NewBizBDe__gende__6C4986A5] DEFAULT ('U'),
[ObservesDST] [bit] NOT NULL CONSTRAINT [DF__NewBizBDe__Obser__6D3DAADE] DEFAULT ((1)),
[RegionCode] [char] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[County] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[TimeZoneOverride] [bit] NOT NULL CONSTRAINT [DF__NewBizBDe__TimeZ__6E31CF17] DEFAULT ((0)),
