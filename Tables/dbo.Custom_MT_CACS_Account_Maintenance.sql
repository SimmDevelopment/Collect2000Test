CREATE TABLE [dbo].[Custom_MT_CACS_Account_Maintenance]
(
...
GO
ALTER TABLE [dbo].[Custom_MT_CACS_Account_Maintenance] ADD CONSTRAINT [PK_Custom_MT_CACS_Account_Maintenance] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
