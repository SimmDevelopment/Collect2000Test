CREATE TABLE [dbo].[Custom_LibreMax_Cures]
(
...
GO
ALTER TABLE [dbo].[Custom_LibreMax_Cures] ADD CONSTRAINT [PK_Custom_LibreMax_Cures] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
