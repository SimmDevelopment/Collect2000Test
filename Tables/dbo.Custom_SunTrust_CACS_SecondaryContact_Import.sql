CREATE TABLE [dbo].[Custom_SunTrust_CACS_SecondaryContact_Import]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_CACS_SecondaryContact_Import] ADD CONSTRAINT [PK_Custom_SunTrust_CACS_SecondaryContact_Import] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
