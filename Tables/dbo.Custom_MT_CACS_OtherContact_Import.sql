CREATE TABLE [dbo].[Custom_MT_CACS_OtherContact_Import]
(
...
GO
ALTER TABLE [dbo].[Custom_MT_CACS_OtherContact_Import] ADD CONSTRAINT [PK_Custom_MT_CACS_OtherContact_Import] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
