CREATE TABLE [dbo].[Custom_SunTrust_Temp_Emails]
(
...
GO
ALTER TABLE [dbo].[Custom_SunTrust_Temp_Emails] ADD CONSTRAINT [PK_Custom_SunTrust_Temp_Emails] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
