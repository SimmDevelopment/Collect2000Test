CREATE TABLE [dbo].[Custom_Suntrust_Temp_Debt_Validation]
(
...
GO
ALTER TABLE [dbo].[Custom_Suntrust_Temp_Debt_Validation] ADD CONSTRAINT [PK_Custom_Suntrust_Temp_Debt_Validation] PRIMARY KEY CLUSTERED ([UID]) ON [PRIMARY]
GO
