CREATE TABLE [dbo].[Custom_USBank_CACS_Contact_Phone_CallTime]
(
...
GO
ALTER TABLE [dbo].[Custom_USBank_CACS_Contact_Phone_CallTime] ADD CONSTRAINT [PK_Custom_USBank_CACS_Contact_Phone_CallTime] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
